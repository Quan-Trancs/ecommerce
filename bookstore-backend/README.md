...
> **Also available in the ecommerce monorepo:**  
> Prefer [`Quan-Trancs/ecommerce`](https://github.com/Quan-Trancs/ecommerce) → folder `bookstore-backend/` (paired with the Next.js storefront). This repo is kept as a historical / backend-only mirror.
