...
export default function AssistOrderLookup({
  basePath = '/support',
  initialEmail = '',
}: {
  /** Where email search should land (e.g. /support or /admin/orders). */
  basePath?: string
  initialEmail?: string
}) {
    ...
    <div className='space-y-3'>
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          startEmail(() => {
            router.push(`${basePath}?email=${encodeURIComponent(trimmed)}`)
          })
        }}
      >
        <Input
