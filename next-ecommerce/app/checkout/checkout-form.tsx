        ...
        <div className='md:col-span-3'>
            ...
            {isAddressSelected && shippingAddress ? (
              <div className='grid grid-cols-1 md:grid-cols-12    my-3  pb-3'>
                <div className='col-span-10 text-sm'>
                  <p className='font-bold text-[18px]'>{`Delivering to ${shippingAddress.fullName}`}</p>
                  <p>
          ...
          <div className='border-y'>
            {isPaymentMethodSelected && paymentMethod ? (
              <div className='grid  grid-cols-1 md:grid-cols-12  my-3 pb-3'>
                <div className='flex text-lg font-bold  col-span-10'>
                  <span>{`Paying with ${paymentMethod}`}</span>
                </div>
                <div className='col-span-2'>
                  <Button
                    variant='outline'
          ...
          <div>
            {isDeliveryDateSelected && deliveryDateIndex != undefined ? (
              ...
              <>
                <div className='flex text-black  text-lg font-bold my-2'>
                              ...
                              {AVAILABLE_DELIVERY_DATES.map((dd) => (
                                <div key={dd.name} className='flex'>
                                  ...
                                  >
                                    ...
                                    <div>
                                      {(dd.freeShippingMinimumPrice > 0 &&
                                      itemsPrice >= dd.freeShippingMinimumPrice
                                        ? 0
                                        : dd.shippingPrice) === 0 ? (
                                        'FREE Shipping'
                                      ) : (
