...
- ~~Follow shop + new-listing alerts~~ (v1.3.86)
- ~~Seller follower count + batched follow digests~~ (v1.3.87)
- ~~Seller shop cover/banner image~~ (v1.3.88)
...
- ~~Seller shop announcements to followers~~ (v1.3.98)
- ~~Shop announcement email digests~~ (v1.3.99)
